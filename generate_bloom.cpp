...
auto main() -> int {
    ...
    int xC_len = 14; //X coordinate length to be checked for being inserted into the bloomfilter (should be equal for generate_bloom and point_search max=33(full length X coordinate))
